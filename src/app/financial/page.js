...
<<<<<<< HEAD
  ...
  useEffect(() => {
    if (searchParams.get('success') === 'true' && searchParams.get('status') === '200') {
      // Mock search results - in a real app, you would fetch these based on the parameters
      setSearchResults([
...
<<<<<<< HEAD
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden mb-6">
          ...
          <div className="p-5">
            {searchParams.get('success') === 'true' && searchParams.get('status') === '201' && (
              <div className="mb-4 p-3 bg-green-50 border border-green-200 text-green-700 rounded-md">
                Transaction submitted successfully! Status code: 201 Created
              </div>
            )}
            
            {searchParams.get('success') === 'false' && (
              <div className="mb-4 p-3 bg-red-50 border border-red-200 text-red-700 rounded-md">
                Error processing transaction. Status code: {searchParams.get('status') || '500'}
              </div>
            )}
...
<<<<<<< HEAD
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden mb-6">
          ...
          <div className="p-5">
            {searchParams.get('success') === 'true' && searchParams.get('status') === '200' && (
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 text-blue-700 rounded-md">
                Search completed! Status code: 200 OK
              </div>
            )}
            
            <form method="get" action="/api/transactions" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
